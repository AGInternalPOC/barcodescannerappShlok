						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#barcodescanner-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"barcodescanner-display": {
								...
								"action": "display",
								"description": "Barcode Scanner for Filtering Records",
								"title": "Barcode Scanner",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=barcodescanner",
									"url": sap.ui.require.toUrl("barcodescanner")
								}
							}
						}
					}
